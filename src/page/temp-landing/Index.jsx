          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              <div>
                ...
                >
                  Welcome to{' '}
                  <span className="bg-gradient-to-r from-codeflow-purple to-codeflow-blue bg-clip-text text-transparent mr-0.5 pl-3">
                    CodeFlow
                  </span>
                </motion.h1>
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-codeflow-purple to-codeflow-blue hover:from-codeflow-purple/90 hover:to-codeflow-blue/90 text-white font-medium px-8 py-6 text-lg group shadow-xl hover:shadow-2xl transition-all duration-300"
                  >
                    Start Practicing
                    <motion.div
                      className="ml-2"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <FeatureCard
              icon={PlayCircle}
              title="Use Playlists"
              description="Follow structured playlists of problems by topic or company to stay consistent and focused."
              delay={0.3}
            />
          </div>
        </div>
