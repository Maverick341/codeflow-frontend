        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 sm:p-12 backdrop-blur-xl shadow-2xl w-full max-w-lg">
          ...
          <div className="relative z-10 w-full">
            ...
            >
              ...
              <h1 className="text-2xl font-bold text-white mb-2 lg:hidden">Join CodeFlow</h1>
              <h1 className="text-2xl font-bold text-white mb-2 hidden lg:block">Create Account</h1>
              <p className="text-white/70 text-sm lg:hidden">Create your account to start coding</p>
              <p className="text-white/70 text-sm hidden lg:block">Fill in your details to get started</p>
            </motion.div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 py-3 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:bg-white/15 focus:border-[#6c5ce7]/50 focus:ring-[#6c5ce7]/25 transition-all duration-300 rounded-lg ${
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 py-3 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:bg-white/15 focus:border-[#6c5ce7]/50 focus:ring-[#6c5ce7]/25 transition-all duration-300 rounded-lg ${
